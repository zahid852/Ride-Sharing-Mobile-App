...
class PassengerHistoryScreen extends StatefulWidget {
  ...
  const PassengerHistoryScreen({Key? key, required this.menuButtonFunction})
      : super(key: key);
...
class _PassengerHistoryScreenState extends State<PassengerHistoryScreen> {
  ...
  void initState() {
    _getRidesHistory =
        Provider.of<PassengerHistoryRidesViewModel>(context, listen: false)
              ...
              child: FutureBuilder(
                  ...
                  builder: (futureCtx, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                                        ...
                                        onPressed: () {
                                          setState(() {
                                            _getRidesHistory = Provider.of<
                                                        PassengerHistoryRidesViewModel>(
                                                    context,
                                                    listen: false)
                      ...
                      return Consumer<PassengerHistoryRidesViewModel>(
                          builder: (consumerCtx, viewModel, _) {
                        if (viewModel.historyRidesList.isEmpty &&
                            !viewModel.isGotData) {
                          return getLoadingWidget(context);
                        } else if (viewModel.historyRidesList.isEmpty &&
                            viewModel.isGotData) {
                          return Center(
                            child: Padding(
                              padding: EdgeInsets.only(
