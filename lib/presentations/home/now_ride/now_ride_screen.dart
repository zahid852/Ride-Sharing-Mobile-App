...
class _NowRideScreenState extends State<NowRideScreen>
  ...
  late CustomTimerController customTimerController = CustomTimerController(
    vsync: this,
    begin: const Duration(minutes: 5, seconds: 0),
      ...
      body: GestureDetector(
        onTap: () {
          WidgetsBinding.instance.addPersistentFrameCallback((_) {
            setState(() {
              _getRequests = nowRideViewModel.getRequestsData(
                  PassengerRequestsGetRequest(widget.data.campaignId));
            });
          });
        },
        child: SafeArea(
            ...
            Consumer<NowRideViewModel>(builder: (consumerCtx, viewModel, _) {
              return Container(
                margin: EdgeInsets.only(
                    bottom: viewModel.requestsList.isNotEmpty ? 10 : 15,
                    top: 10),
                ...
                child: ElevatedButton(
                    ...
                    child: Text(
                      'Start Ride',
                      style: GoogleFonts.nunito(
                          fontSize: nowRideViewModel.requestsList.isNotEmpty
                              ? 17
                              : 18,
                          fontWeight: FontWeight.w700),
                    )),
