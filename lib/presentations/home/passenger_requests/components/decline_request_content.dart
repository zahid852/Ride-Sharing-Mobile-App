...
class PassengerDeclineRequestBody extends StatefulWidget {
  final List<PassengerAllRequests> passengerRequests;
  const PassengerDeclineRequestBody({Key? key, required this.passengerRequests})
      : super(key: key);

  @override
  State<PassengerDeclineRequestBody> createState() =>
      _PassengerDeclineRequestBodyState();
}

class _PassengerDeclineRequestBodyState
    extends State<PassengerDeclineRequestBody> {
  @override
  Widget build(BuildContext context) {
    List<PassengerAllRequests> requests =
        widget.passengerRequests.where((request) {
      return request.requestStatus == 'decline' ? true : false;
    }).toList();
