...
class PassengerAcceptedRequestBody extends StatefulWidget {
  final List<PassengerAllRequests> passengerRequests;
  const PassengerAcceptedRequestBody(
      {Key? key, required this.passengerRequests})
      : super(key: key);

  @override
  State<PassengerAcceptedRequestBody> createState() =>
      _PassengerAcceptedRequestBodyState();
}

class _PassengerAcceptedRequestBodyState
    extends State<PassengerAcceptedRequestBody> {
  @override
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'There are no accepted requests yet.',
